...
> **Archived — January 2025.** This report predates the Notion migration, TypeScript conversion, and July 2026 refactors. Many file paths and findings below are outdated. For current setup see [AGENTS.md](../AGENTS.md) and [DEVELOPMENT_NOTES.md](DEVELOPMENT_NOTES.md).
...
The detailed findings below are preserved for historical reference.
