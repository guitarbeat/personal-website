...
/**
 * Custom hook to encapsulate OGL canvas initialization, animation loop,
 * and event listener bindings for the Moire effect.
 */
export function useMoireEffect(containerRef: RefObject<HTMLDivElement | null>) {
  useEffect(() => {
