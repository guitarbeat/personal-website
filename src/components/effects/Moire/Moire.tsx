...
const initMoireEffect = (containerEl: HTMLDivElement | null) => {
  ...
  const animate = () => {
    ...
    state.camera.position.z += (state.cameraZ - state.camera.position.z) * 0.02;
...
function MagicComponent({
  ...
  useEffect(() => {
    ...
    const timeoutId = setTimeout(() => {
      ...
      internalCleanup = initMoireEffect(containerEl);
    }, 0);
