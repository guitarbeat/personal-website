...
export const useMatrixRain = (
  ...
  useEffect(() => {
    ...
    const isSlowDevice =
      // biome-ignore lint/suspicious/noExplicitAny: Navigator extension
      (navigator as any).deviceMemory < 4;
    const _isLowBattery = (// biome-ignore lint/suspicious/noExplicitAny: Navigator extension
      navigator as any)
      .getBattery?.()
      .then((// biome-ignore lint/suspicious/noExplicitAny: battery api
        battery: any) => battery.level < 0.2);
