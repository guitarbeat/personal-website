...
export const AuthProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: conditional dependencies
  ...
  return (
    <AuthContext.Provider
      // biome-ignore lint/correctness/useExhaustiveDependencies: explicit dependencies
      value={useMemo(
        () => ({
          isUnlocked,
          isMobileUnlocked,
