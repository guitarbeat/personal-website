        ...
        <div className="hack-terminal-screen">
          <div className="matrix-console-grid">
            ...
            >
              ...
              {/* biome-ignore lint/a11y/useSemanticElements: Preserving div structure for layout */}
              <div
              ...
              >
                <div className="hack-input-stream" aria-hidden="true">
                  {consoleDisplay.split("\n").map((line, i) => {
                    ...
                    return (
                      // biome-ignore lint/suspicious/noArrayIndexKey: Console output order is static
