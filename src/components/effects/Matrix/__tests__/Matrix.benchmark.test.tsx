...
describe("Matrix Performance", () => {
  ...
  beforeEach(() => {
    ...
    // biome-ignore lint/suspicious/noExplicitAny: Mocking canvas context requires type override
    HTMLCanvasElement.prototype.getContext = mockGetContext as unknown as any;
