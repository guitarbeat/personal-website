...
- Export `getSnapshotAgeSeconds` from `helpers.js` in the Notion barrel (restores Vite/CI build)
- Biome formatting on archived `split-notion-content.js` (restores Code Quality CI)
- Vite `REACT_APP_VERSION` reads from `package.json` (aligned with CRACO)
...
[0.1.1]: https://github.com/guitarbeat/personal-website/releases/tag/v0.1.1
